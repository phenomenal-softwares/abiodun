...
function viewFeatures(x) {
  if (x == 1) {
    ...
    name.innerHTML = "Rhodes Organic Essentials";
    type.innerHTML = "Website";
    mode.innerHTML = "Single product, e-commerce";
    features.innerHTML = `
    <li>Responsive</li> 
...
//reverse slide nav order
function reverseOrder() {
    const container = document.querySelector(".slides-nav");
    const items = Array.from(container.children);

    // Reverse the items and append them back to the container
